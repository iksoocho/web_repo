...
const json =`[{"id":1,"first_name":"Tiff","last_name":"Revely","email":"trevely0@twitter.com","gender":"Female","salary":4129},
...
for(let i=0;i<members.length;i++){
    if((members[i].gender=="Female")&&(members[i].salary>4500)){
        targetAry.push(members[i]);
    }
}
for(let ary of targetAry){
    console.log(ary);
}